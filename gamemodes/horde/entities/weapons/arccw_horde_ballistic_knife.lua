...
SWEP.Slot = 0
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_bo1_ballistic_knife.vtf")
    killicon.Add("arccw_horde_ballistic_knife", "arccw/weaponicons/arccw_bo1_ballistic_knife", Color(0, 0, 0, 255))
end
SWEP.UseHands = true
