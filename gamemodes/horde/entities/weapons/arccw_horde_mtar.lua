...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_bo2_mtar.vtf")
    killicon.Add("arccw_horde_mtar", "arccw/weaponicons/arccw_bo2_mtar", Color(0, 0, 0, 255))
end
SWEP.Damage = 35
