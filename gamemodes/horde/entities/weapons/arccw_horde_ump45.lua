...
if CLIENT then
    SWEP.WepSelectIcon = surface.GetTextureID("arccw/weaponicons/arccw_go_ump.vtf")
    killicon.Add("arccw_horde_ump45", "arccw/weaponicons/arccw_go_ump", Color(0, 0, 0, 255))
end
SWEP.Damage = 34
SWEP.DamageMin = 29
SWEP.Horde_MaxMags = 16
