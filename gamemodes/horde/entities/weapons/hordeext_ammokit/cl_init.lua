...
SWEP.VElements = {
	...
	["ammobox"] = { type = "Model", model = "models/items/boxmrounds.mdl", bone = "medkit_bone", rel = "", pos = Vector(-0.5,4,-1.5), angle = Angle(90,185,90), size = Vector(0.4, 0.4, 0.4), color = Color(0, 255, 0, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
