...
function ENT:Initialize()
	...
	timer.Create("notargettest", 0, 1, function() if self:GetOwner():IsFlagSet(FL_NOTARGET) then
		//self.Owner:PrintMessage(HUD_PRINTTALK, "Error: notarget is set to true. Rockets will not follow you!")
	end end)
end
...
function ENT:Explode()
	...
	util.BlastDamage(self, self:GetOwner(), self:GetPos(), 200, 80)
